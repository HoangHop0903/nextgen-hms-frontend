...
export default function AdminDashboard() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex transition-colors duration-300">
      {/* Sidebar */}
      <div className="w-64 bg-slate-900 dark:bg-slate-950 border-r dark:border-slate-800 text-slate-300 flex flex-col shadow-xl z-10 transition-colors duration-300 flex-shrink-0 sticky top-0 h-screen">
